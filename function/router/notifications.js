...
router.post('/', (req, res) => {
    ...
    MongoClient.connect(url, function (err, client) {
        ...
        var newvalues = {
            $push: {
                "notifications": { "title": req.body.title, "body": req.body.body, "data": req.body.data !==null ? req.body.data : {}, "timestamp": req.body.timestamp ?? Math.floor(Date.now() / 1000).toString() }
            }
        };
